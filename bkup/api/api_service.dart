...
import 'package:app/src/slices/blockchain/model/api_blockchain_model_address_rsp_code.dart';
...
import 'helpers/helper_api_headers.dart';
...
class ApiService {
  ...
  getTotal() async {
    ...
    http.Response rsp = await http
        .get(ConfigDomain.asUri(ConfigDomain.signup, path), headers: headers);
