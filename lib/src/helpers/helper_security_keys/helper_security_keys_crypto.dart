...
Future<AsymmetricKeyPair<ECPublicKey, ECPrivateKey>> createECDSA() async {
  return await compute(_createECDSA, "").then((keyPair) => keyPair);
}

Future<AsymmetricKeyPair<RSAPublicKey, RSAPrivateKey>> createRSA() async {
  return await compute(_createRSA, "").then((keyPair) => keyPair);
}

AsymmetricKeyPair<ECPublicKey, ECPrivateKey> _createECDSA(var dummy) {
...
AsymmetricKeyPair<RSAPublicKey, RSAPrivateKey> _createRSA(var dummy) {
